...
class BinarySerchTree(QWidget):
    ...
    def query(self,root, val):
        ...
        if root.val is val:
            ...
            "color:red;border:none;background-color:rgba(255,255,255,0);border-image:url(dist/this.png);font-size:20px;")
            # time.sleep(1)
            # root.label.setStyleSheet(
        ...
        if root.val < val:
            ...
            time.sleep(x)
            root.label.setStyleSheet(
                "color:red;border:none;background-color:rgba(255,255,255,0);border-image:url(dist/element.png);font-size:20px;")
            time.sleep(x)
            root.label.setStyleSheet(
                "color:red;border:none;background-color:rgba(255,255,255,0);border-image:url(dist/this.png);font-size:20px;")
            time.sleep(x)
